...
func (repo *PSQLAUTH) CreateUsers(ctx context.Context, user domain.Users) (int, error) {
...
func (repo *PSQLAUTH) GetUsers(ctx context.Context, username, password string) (domain.Users, error) {
...
func (repo *PSQLAUTH) CreateToken(ctx context.Context, token domain.RefreshSession) error {
...
func (repo *PSQLAUTH) GetToken(ctx context.Context, token string) (domain.RefreshSession, error) {
